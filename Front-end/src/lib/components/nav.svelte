<nav class="fixed top-0 left-0 z-50 flex h-20 w-full items-center justify-between border-b border-white/10 bg-black/40 px-4 backdrop-blur-md sm:px-10">
    <!-- Logo: Smaller on mobile (text-xl), larger on desktop (sm:text-2xl) -->
    ...
    <!-- Button: Adjusted padding and font for mobile -->
    <a href="/About.us">
...
<!-- This spacer prevents your content from being hidden behind the fixed navbar -->
